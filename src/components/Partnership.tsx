...
const Partnership = () => {
  return (
    <section id="partnership" className="py-24 bg-gradient-to-br from-primary/5 via-background to-secondary/5">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 md:p-12 text-white text-center animate-fade-in" style={{ animationDelay: '300ms' }}>
